...
4. Do the work as an ordinary turn.
   ...
   A turn that does not say what to do, or which project to do it to, is not an order yet: ask for the missing part under [`references/speaking.md`](references/speaking.md) rather than dispatching a guess.
