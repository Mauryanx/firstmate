...
# The vc- row is appended directly with fm_wake_append: this regression is about
# what the drain does with such a row, so it needs the key, not a live capture.
