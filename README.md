...
- [docs/voice-relay.md](docs/voice-relay.md) - the optional spoken interface: the conversation transport that carries a spoken turn to the first mate and its published reply back, setup on both machines, measured round-trip cost, what a spoken answer may read, and what this build does not do yet.
